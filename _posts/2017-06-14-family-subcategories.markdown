...
BVN has their standard list of subcategories that families should use - this ensures consistency throughout the project. This list can be found in newforma or [here](S:\idt\DT\Template - Update\06_Categories and Subcategories). Below is a sample list of families that have BVN and non BVN standard subcategories.
